...
quarter-hour (Bolt Dynamisch, Cociter, EBEM, Ecofix, Ecopower Dynamische Burgerstroom, energie.be, Energy Knights Agilior Online, EnergyVision, Engie and OCTA+, plus Frank Energie with the quarter-hour box ticked), which keep the
...
| --- | --- | --- |
| `duration_hours` | _required_ | Window length in whole hours (1-48). On a 15-minute contract (Bolt Dynamisch / Cociter / EBEM / Ecofix / Ecopower Dynamische Burgerstroom / energie.be / Energy Knights Agilior Online / EnergyVision / Engie / OCTA+, and Frank Energie with the quarter-hour box ticked) the window aligns to quarter-hour boundaries. |
