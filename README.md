...
- **Compare every supplier (ranked)** — a separate menu entry from the one-off
  ...
  first. **Your own contract is in the table**, marked, priced from the card
  your entry already holds rather than re-fetched — so it keeps the signing
