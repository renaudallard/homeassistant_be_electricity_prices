...
| `ev_home_charging_rate` | The CREG's rate for reimbursing a company car charged at home, EUR/kWh, for your region and the running quarter: what an employer may repay per metered kWh free of tax and social contributions (circular 2024/C/77), and what most car policies pay. Read off the CREG's own CSV once a quarter. Attributes carry the quarter and every quarter published, so last quarter's kWh can be settled at last quarter's rate. Not part of `current_price`. |
