...
- **Compare another supplier** — one-off price quote against a different
  ...
  contract, or a spot-indexed-injection target like Cociter Variable on
  the injection regime) and your current entry doesn't already carry
  one. Static
