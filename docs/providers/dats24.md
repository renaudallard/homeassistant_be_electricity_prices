...
| Wrong publication label / `valid_until` | `_extract_publication` (`dats24.py:512-514`), `parse_valid_until` (`_pdf.py:922`) | `TARIEFKAART <month> <year>` or the `GELDIG VAN` header changed |
