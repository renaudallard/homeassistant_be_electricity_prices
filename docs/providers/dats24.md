...
(`dats24.py:142-153`) from `_CDN_BASE` (`dats24.py:109`):
...
| Wrong publication label / `valid_until` | `_extract_publication` (`dats24.py:512-514`), `parse_valid_until` (`_pdf.py:794`) | `TARIEFKAART <month> <year>` or the `GELDIG VAN` header changed |
