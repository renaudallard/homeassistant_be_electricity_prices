...
| `version` | `0.17.7` | Manifest version. CI auto-tags and publishes a release when this bumps on `main`. |
...
4. `async_config_entry_first_refresh` runs `_async_update_data` (`coordinator.py:534`). It runs
